...
PLUGIN_DIR="${HOP_HOME}/plugins/transforms/hop-json-object-builder"
VERSION="$(mvn -U -B -ntp -q -DforceStdout help:evaluate -Dexpression=project.version)"
ZIP_PATH="assemblies/assemblies-hop-json-object-builder/target/hop-json-object-builder-plugin-${VERSION}.zip"
...
echo "JSON Object Builder plugin synced to ${PLUGIN_DIR}"
